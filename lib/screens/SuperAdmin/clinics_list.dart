...
class _ClinicsListScreenState extends State<ClinicsListScreen> {
  ...
  List<ClinicModel> get _filteredClinics {
    final clinicVM = Provider.of<ClinicViewModel>(context);
    if (_searchQuery.isEmpty) {
      return clinicVM.clinics;
    }
    return clinicVM.clinics.where((clinic) {
              ...
              return Column(
                children: [
                  ...
                  if (clinicVM.error != null)
                    _buildErrorWidget(clinicVM.error!),
                  // Clinics List
                  Expanded(
                    child: clinicVM.isLoading
                        ? _buildLoadingWidget()
