...
class _SessionManagementWidgetState extends State<SessionManagementWidget> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildTokenStatus(authVM),
                const SizedBox(height: 16),
                _buildTokenDetails(authVM),
                const SizedBox(height: 16),
  ...
  Widget _buildTokenStatus(AuthViewModel authVM) {
  ...
  Widget _buildTokenDetails(AuthViewModel authVM) {
    final tokens = authVM.tokens;
    if (tokens == null) return const SizedBox.shrink();
